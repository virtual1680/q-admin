...
module.exports = {
	...
	prompt: {
		...
		types: [
			...
			{ value: 'ci', name: 'ci: 🎡  Changes to our CI configuration files and scripts->修改 CI 配置、脚本', emoji: '🎡' },
			{ value: 'chore', name: "chore:  ⏪️  Other changes that don't modify src or test files->回滚 commit", emoji: '⏪️' },
			{
				value: 'revert',
